...
### Senior Software Engineer · Front-End Engineering · Leveraging Generative AI

> Turning product ideas into scalable, responsive, and production-ready applications with AI-assisted development, enabling up to 2× faster delivery.

## 🛠️ Tech Stack

| Domain | Skills / Tools |
|--------|----------------|
| **Frontend** | HTML 5, CSS 3, JavaScript, React.js, Bootstrap 5, Tailwind CSS |
| **CMS** | WordPress, Shopify |
| **Design** | Figma, Adobe XD, Photoshop, Canva |
| **AI Tools** | ChatGPT, Gemini, Claude AI, Cursor AI |
| **Collaboration** | Jira, Asana, Notion, Basecamp |
